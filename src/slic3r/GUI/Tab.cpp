...
void TabPrint::build()
{
    ...
    page = add_options_page(L("Multimaterial"), "custom-gcode_multi_material"); // ORCA: icon only visible on placeholders
        ...
        optgroup = page->new_optgroup(L("Filament Lookahead"), L"param_flush");
        optgroup->append_single_option_line("filament_lookahead");
        optgroup->append_single_option_line("filament_lookahead_max_height");
        optgroup->append_single_option_line("filament_lookahead_clearance");
