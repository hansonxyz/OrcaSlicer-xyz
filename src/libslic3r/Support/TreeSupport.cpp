...
void TreeSupport::generate_toolpaths()
{
    ...
    coordf_t nozzle_diameter = m_print_config->nozzle_diameter.get_at(resolve_support_filament_for_nozzle(object_config.support_filament.value, *m_print_config));
